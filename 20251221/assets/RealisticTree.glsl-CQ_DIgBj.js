import{iP as $e,et as x,eP as k,fn as Fe,kg as et,ei as Bt,fG as Ht,iI as Wt,gg as L,iy as kt,pE as Ut,k2 as Yt,w_ as tt,af as c,ag as H,ai as at,w$ as Zt,x0 as qt,kk as Q,fg as ot,kj as Oe,iG as De,iw as Xt,mn as Jt,x1 as U,_ as he,ho as rt,k1 as ne,cj as re,dS as Kt,dU as Qt,a8 as ea,bl as ta,jC as aa,cW as oa,eB as z,fM as ra,iV as ia,eU as na,eE as sa,eG as la,es as we,eu as ca,eX as je,eC as da,iu as ua}from"./index-B08XdrMj.js";import{ab as P,i as me,d as pe,aX as I,a as it,aY as fe,aZ as nt,a_ as st,a$ as ha,b0 as W,b1 as ma,b2 as pa,ad as fa,f as va,b3 as J,r as N,a2 as ae,D as A,E as G,b4 as D,G as K,b as y,I as j,al as ga,H as xa,b5 as ba,b6 as lt,q as se,aj as ct,o as dt,aU as ut,g as wa,j as Ne,k as ve,s as ht,b7 as ya,aH as Ma,u as Ta,v as Be,ah as _a,aa as _,aF as Ie,ag as Sa,b8 as Ca,c as ee,b9 as za,X as oe,ba as $a,M as Fa,bb as mt,a9 as le,F as pt,L as ft,K as vt,bc as gt,J as xt,N as Oa,T as Na,O as Ia,P as Va,Q as La,R as Pa,U as Ea,V as Ra,W as Aa,Y as Ga,x as m,A as Da,bd as ye,be as Me,a1 as ja,aq as Ba,B as Ha,aS as Wa,a3 as ka,az as Ua}from"./OutputColorHighlightOID.glsl-CdwGog2C.js";import{t as ze,Q as Ve}from"./InterleavedLayout-D94lQ4tV.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-CqqqbEHE.js";import{r as Ya}from"./VertexBuffer-BWnHjUiE.js";import{g as Za}from"./plane-ChjgWSaB.js";import{T as Le,d as Pe,_ as qa}from"./renderState-CKc66y4x.js";import{t as Xa}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as ge}from"./ShaderBuilder-C5rr3sDa.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
gl_FragDepth = _linearDepth;
  ...
  `)}function Ct(a,e){const{vertex:t,fragment:r,varyings:o}=a,{hasColorTexture:s,alphaDiscardMode:d}=e,n=s&&d!==1,{output:l,normalType:u,hasColorTextureTransform:f}=e;switch(l){case 2:A(t,e),a.include(G),r.include(j,e),a.include(D,e),n&&r.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),a.include(B,e),r.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(G),a.include(D,e),a.include(K,e),a.include(po,e),r.include(j,e),a.include(xa,e),ba(a),o.add("depth","float",{invariant:!0}),n&&r.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),a.include(B,e),r.main.add(i`
        ...
        ${l===10?i`outputObjectAndLayerIdColor();`:i`outputDepth(depth);`}`);break;case 3:{A(t,e),a.include(G),a.include(xe,e),a.include(wt,e),a.include(D,e),a.include(K,e),n&&r.uniforms.add(new y("tex",M=>M.texture)),u===2&&o.add("vPositionView","vec3",{invariant:!0});const v=u===0||u===1;t.main.add(i`
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case 9:A(t,e),a.include(G),a.include(D,e),a.include(K,e),n&&r.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
return texture(_shadowMap, uvzShadow);
  ...
  `)}function Go(a){a.include(Ro),a.fragment.uniforms.add(new Ao("shadowMap",({shadowMap:e})=>e.depthTexture)).code.add(i`float readShadowMap(const in vec3 _worldPos, float _linearDepth) {
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ft,a),o.include(Ee,a),e.include(B,a),o.include(j,a),e.include(xt,a),le(o,a),ue(o),Ae(o),Ge(o),o.uniforms.add(r.uniforms.get("localOrigin"),r.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&o.uniforms.add(new y("tex",g=>g.texture)),e.include(Ot,a),o.include(Re,a),o.include(Pt),o.include(Et,a),te(o),o.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
